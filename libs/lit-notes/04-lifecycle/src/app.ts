  ...
  render() {
    return html`
      <main>
        ...
        <attribute-changed-callback-element msg=${this.msg}></attribute-changed-callback-element>
        ...
        <input
          type="text"
          @input=${this._handleChangedPropertiesMapInput} />
        <changed-properties-map-element
          msg=${this.changedPropertiesMapMsg}></changed-properties-map-element>

        <h3>07 - TriggeringUpdate</h3>
        <triggering-update-element></triggering-update-element>

        <h3>08 - PerformingUpdate</h3>
        <performing-update-element
          prop1=${this.prop1}
          prop2=${this.prop2}></performing-update-element>
        <label>
          Prop1:
          <input
            type="text"
            @input=${this._handleProp1Input} />
        </label>
        <label>
          Prop2:
          <input
            type="text"
            @input=${this._handleProp2Input} />
        </label>
