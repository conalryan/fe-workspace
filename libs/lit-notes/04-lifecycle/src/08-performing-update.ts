...
export class PerformingUpdateElement extends LitElement {
  ...
  override shouldUpdate(changedProperties: Map<string, any>) {
    console.info('[PerformingUpdateElement] shouldUpdate()', changedProperties);
  ...
  override update(changedProperties: PropertyValues<this>) {
    console.info('[PerformingUpdateElement] update()', changedProperties);
  ...
  override willUpdate(changedProperties: PropertyValues<this>) {
    console.info('[PerformingUpdateElement] willUpdate()', changedProperties);
